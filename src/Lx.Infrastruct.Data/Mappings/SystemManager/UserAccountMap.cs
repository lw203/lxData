...
namespace Lx.Infrastruct.Data.Mappings.SystemManager
{
    public class UserAccountMap : IEntityTypeConfiguration<UserAccount>
    {
        ...
        public void Configure(EntityTypeBuilder<UserAccount> builder)
        {
            ...
            .WithOne(b => b.UserAccount)//设置Book实体通过属性Person可以找到一个Person实体，表示Book表是一对多关系中的从表
            .HasPrincipalKey(p => p.Id)//设置Person表的PersonCode列为一对多关系中的主表键
            .HasForeignKey(b => b.USERId)//设置Book表的PersonCode列为一对多关系中的从表外键
            .OnDelete(DeleteBehavior.ClientSetNull)
            .HasConstraintName("FK_LOGIN_RECORD_USERID");//设置一对多关系的级联删除效果为DeleteBehavior.ClientSetNull
        }
    }
}
